...
NOT_REGISTERED_ERROR = f"¡Ups! Parece que no estás conectado a tu cuenta de {EVENT_NAME}. Escribe `{COMMAND_PREFIX}login` para volver a iniciar el proceso de registro."
